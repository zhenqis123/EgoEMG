...
**Pre-crops:** `/mnt/nvme/xiziheng/EgoEMG_v2_crops/` — per-episode LMDB files containing
JPEG-encoded 256×256 hand crops at `FF:NNNNNNNN_H` keys (frame index + hand code).

**EMG data:** `/mnt/nvme/xiziheng/EgoEMG_v2_memmap/` — EgoEMG v2 memmap with 8-channel EMG layout
