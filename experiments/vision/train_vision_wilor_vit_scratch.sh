...
# WiLoR ViT-Huge Random-Init Vision-Only Baseline
# Same architecture as vision_wilor_vit but NO pretrained weights.
# Pre-cropped 256×256 images → ViT-H/14 (random init) → 22 joint angles.
