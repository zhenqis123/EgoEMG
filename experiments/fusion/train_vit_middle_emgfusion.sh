...
# ViT Middle + EMGFormer Small Fusion
# Cached ViT features (1280-dim) → 256-dim projection + frozen EMGFormer small → trainable fusion layers

CONFIG="experiment=fusion/vision_vit_middle_emgfusion"
