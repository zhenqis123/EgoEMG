...
from emg2pose.lightning_spatial_rope import SpatialRoPELightningModule
...
def make_lightning_module(config: DictConfig):
    ...
    return SpatialRoPELightningModule(
        model_conf=config.module,
...
def train(
    ...
    if config.checkpoint is not None:
        ...
        module = SpatialRoPELightningModule.load_from_checkpoint(
            config.checkpoint,
            model_conf=config.module,
            optimizer_conf=config.optimizer,
            lr_scheduler_conf=config.lr_scheduler,
        ...
        log.info(f"Instantiating LightningModule {SpatialRoPELightningModule}")
