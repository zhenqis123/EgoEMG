...
from .hand import DOF_PER_FINGER, HandModel, NUM_DIGITS, NUM_JOINT_FRAMES

# NOTE: see EMG2POSE_DEVELOPER_NOTE.md
# from pytorch3d.transforms import so3_exp_map
from .pytorch3d_transforms_so3 import so3_exp_map
