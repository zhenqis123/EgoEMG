...
RUN_NAME=fusion_rn50_m_egoemg_only_wl12000_crossattn_2layer_lastblock_anchor_augbest_20e
...
CUDA_VISIBLE_DEVICES="$GPUS" python -m emg2pose.train \
  experiment=fusion/fusion_rn50_m_egoemg_only_wl12000_crossattn_2layer_lastblock_anchor_augbest_20e \
