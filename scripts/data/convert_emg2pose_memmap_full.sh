...
ZARR_ROOT="/home/xiziheng/develop/emg2pose/data/emg_corpus/emg2pose_v3"
MEMMAP_ROOT="/home/xiziheng/develop/emg2pose/data/emg_corpus/emg2pose_v3_memmap"
...
# 检查磁盘空间
AVAILABLE_GB=$(df -BG /home/xiziheng/develop/emg2pose/data/emg_corpus/ | grep nvme | awk '{print $4}' | sed 's/G//')
REQUIRED_GB=465
