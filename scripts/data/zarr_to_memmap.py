...
Usage:
    ...
    python scripts/convert_data/zarr_to_memmap.py \
        --zarr-root /mnt/nvme/xiziheng/emg_corpus/emg2pose_v3 \
        --output-dir /mnt/nvme/xiziheng/emg_corpus/emg2pose_v3_memmap \
        --fields emg valid_mask

    # emg2qwerty (emg_left + emg_right + time):
    python scripts/convert_data/zarr_to_memmap.py \
        --zarr-root /mnt/nvme/xiziheng/emg_corpus/emg2qwerty_v3 \
        --output-dir /mnt/nvme/xiziheng/emg_corpus/emg2qwerty_v3_memmap \
